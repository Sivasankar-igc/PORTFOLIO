...
import notemate from "../ICONS/notemate.jpg"
            ...
            <section className="latestProject__wrapper">
                ...
                <div className="lp__box">
                    <div className="card">
                        ...
                        <img src={typing} id="image-cont" onClick={() => window.open("https://thetyper.onrender.com", "_blank")} />
                        ...
                        <div className="content">
                            ...
                            <a href="https://thetyper.onrender.com" target="_blank" style={{ color: "#0fc6ff" }}>VISIT</a>
                        </div>
                    </div>
                    <div className="card">
                        <header>Employee Management System</header>
                        <img src={employee} id="image-cont" onClick={() => window.open("https://ems-oxo4.onrender.com/", "_blank")} />
                        <p onClick={() => slideTheContent(1)}>Know More</p>
                        <div className="content">
                            This website lists all the employees with their name, gender, post, availability and other details. The Team Leaders can select employees, create, manage and modify their team. It shows real-time data. <a href="https://ems-oxo4.onrender.com/" target="_blank" style={{ color: "#0fc6ff" }}>VISIT</a>
                        </div>
                    </div>
                    <div className="card">
                        <header>Content Management System</header>
                        <img src={content} id="image-cont" onClick={() => window.open("https://github.com/Sivasankar-igc/CMS", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={anime} id="image-cont" onClick={() => window.open("https://github.com/Sivasankar-igc/AnimeTodo", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={house} id="image-cont" onClick={() => window.open("https://github.com/Sivasankar-igc/SEARCHYOURHOUSE", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={exam} id="image-cont" onClick={() => window.open("https://github.com/Sivasankar-igc/OnlineExamPortal", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={bingo} id="image-cont" onClick={() => window.open("https://onlinebingo.onrender.com/", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={tictactoe} id="image-cont" onClick={() => window.open("https://tic-tac-toe-re34.onrender.com/", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={weather} id="image-cont" onClick={() => window.open("https://weather-app-kh7o.onrender.com", "_blank")} />
                    ...
                    <div className="card">
                        ...
                        <img src={notemate} id="image-cont" onClick={() => window.open("https://notemate-uwix.onrender.com/", "_blank")} />
                        <p onClick={() => slideTheContent(9)}>Know More</p>
                        <div className="content">
                            Our platform helps users post notes on different subjects. We aim to provide a seamless and collaborative environment for sharing and discovering knowledge. <a href="https://notemate-uwix.onrender.com/" target="_blank" style={{ color: "#0fc6ff" }}>VISIT</a>
                        </div>
                    </div>
                </div>
            </section>
